...
class QuestionModelTests(TestCase):
    """
    To test a model should use a class with the name of
    MODELModelTests which inherits from django.test.TestCase
    """
...
def create_question(question_text, days):
    ...
    given number of `days` offset to now (negetive for questions published in
